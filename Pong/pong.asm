...
;       Right paddle movement
		CHECK_RIGHT_PADDLE_MOVEMENT:
		    ...
		    cmp AI_CONTROLLED,00h
		    JE CONTROL_BY_AI
		    
		    ;when paddle controlled by the userby pressing a key
		    CHECK_FOR_KEYS:
            ...
            CONTROL_BY_AI:
                ;check if the ball above the paddle (BALL_Y + BALL_SIZE < PADDLE_RIGHT_Y)
                ...
                ;check if the ball below the paddle (BALL_Y > PADDLE_RIGHT_Y + PADDLE_HEIGHT)
                ...
                ;if nono is true, then don't move the paddla (exit paddle movement)
